...
var systemPrompts = map[string]string{
	"deepseek-v4-pro": "You are an expert programming assistant. Help with coding tasks, explain concepts clearly, " +
	...
	"deepseek-v4-flash": "You are an expert programming assistant. Help with coding tasks, explain concepts clearly, " +
		"provide correct and idiomatic code examples, debug issues, and follow best practices. " +
		"Be concise and direct. When showing code, use the appropriate language and include only what is necessary." +
		agentParallelismHint,
}
