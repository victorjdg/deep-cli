...
| [agent-mode.md](./agent-mode.md)                | Tool calling loop, available tools, security model      |
...
| [tui-components.md](./tui-components.md)        | All UI components and their responsibilities            |
